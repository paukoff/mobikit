...
Dragdealer.prototype = {
  ...
  init: function() {
    if (this.options.css3) {
      ...
      console.log(triggerWebkitHardwareAcceleration(this.handle));
    }
    this.value = {
      prev: [-1, -1],
  ...
  renderHandlePosition: function() {
    ...
    if (this.options.css3 && StylePrefix.transform) {
      if (this.options.horizontal) {
        transform += 'translate3d(0px,' + this.offset.current[0] + 'px,0px);';
      }
      if (this.options.vertical) {
        transform += ' translate3d(0px,' + this.offset.current[1] + 'px,0px);';
